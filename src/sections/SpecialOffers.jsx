    ...
    <section id='special-offer' className="flex justify-wrap items-center max-xl:flex-col-reverse gap-10 max-container">
      ...
      <div className="flex flex-1 flex-col">
        ...
        <div className="mt-11 flex flex-wrap">
          ...
          <button className="mr-4 flex justify-center items-center gap-2 px-7 py-4 border font-monsterrat text-lg leading-none rounded-full text-slate-gray border-slate-gray">
            Learn More
          </button>
        </div>
      </div>
